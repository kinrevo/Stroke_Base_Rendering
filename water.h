...
// UpdateVelocities：Bの係数(def:0.1)   //ここで水速度の暴走をある程度おさえられる
#define opt_mhu 0.01
...
// SimulateCapillaryFlow：浅水層から毛細層に水の浸透する割合(def:)(paper:0.5)
#define opt_alpha 0.5
// SimulateCapillaryFlow：毛細層の水がこれより多いと隣に溢れる(def:)(paper:0.62)
#define opt_epsilon 0.5
// SimulateCapillaryFlow：毛細層の水がこれより多いと隣から水が来ない(def:)(paper:0.65)
#define opt_delta 0.65
// SimulateCapillaryFlow：毛細層の水がこれより多いとウェットエリアに加えられる(def:)(paper:0.001)
#define opt_sigma 0.001

// set_WetStroke：水量の初期値をどれだけ中心に寄せるか(def:1.5)
